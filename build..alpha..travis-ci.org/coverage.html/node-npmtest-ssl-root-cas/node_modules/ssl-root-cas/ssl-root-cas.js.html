...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-ssl-root-cas/node_modules/ssl-root-cas/ssl-root-cas.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-ssl-root-cas">npmtest-ssl-root-cas (v0.0.1)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-ssl-root-cas/node_modules/ssl-root-cas/ssl-root-cas.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-ssl-root-cas/node_modules/ssl-root-cas/</a> &#187; ssl-root-cas.js</div>
</div>
<div class="body">
...
4132
4133
4134</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
module.exports.rootCas.inject = <span class="fstat-no" title="function not covered" >function (/*context*/) {</span>
<span class="cstat-no" title="statement not covered" >  var rootCas = this || module.exports.rootCas;</span>
<span class="cstat-no" title="statement not covered" >  var opts = /*context ||*/ require('https').globalAgent.options;</span>
<span class="cstat-no" title="statement not covered" >  if (!opts.ca || !opts.ca.__injected) { <span class="cstat-no" title="statement not covered" >opts.ca = (opts.ca||[]).concat(rootCas); </span>}</span>
<span class="cstat-no" title="statement not covered" >  opts.ca.__injected = true;</span>
<span class="cstat-no" title="statement not covered" >  return rootCas;</span>
};
module.exports.rootCas.addFile = <span class="fstat-no" title="function not covered" >function (filepath) {</span>
  // BEGIN TODO
...
<span class="cstat-no" title="statement not covered" >  var root = (filepath[0] === '/' ? '/' : '');</span>
<span class="cstat-no" title="statement not covered" >  var filepaths = filepath.split(/\//g);</span>
<span class="cstat-no" title="statement not covered" >  if (root) { <span class="cstat-no" title="statement not covered" >filepaths.unshift(root); </span>}</span>
<span class="cstat-no" title="statement not covered" >  filepath = path.join.apply(null, filepaths);</span>
  // END TODO
&nbsp;
<span class="cstat-no" title="statement not covered" >  var httpsOpts = require('https').globalAgent.options;</span>
<span class="cstat-no" title="statement not covered" >  var rootCas = this || module.exports.rootCas;</span>
<span class="cstat-no" title="statement not covered" >  var buf = require('fs').readFileSync(filepath);</span>
<span class="cstat-no" title="statement not covered" >  rootCas.push(buf);</span>
  // backwards compat
<span class="cstat-no" title="statement not covered" >  if (rootCas !== httpsOpts.ca) {</span>
<span class="cstat-no" title="statement not covered" >    httpsOpts.ca = httpsOpts.ca || [];</span>
<span class="cstat-no" title="statement not covered" >    httpsOpts.ca.push(buf);</span>
  }
<span class="cstat-no" title="statement not covered" >  return rootCas;</span>
};
module.exports.create = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  var rootCas = originalCas.slice(0);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  rootCas.inject = module.exports.inject;</span>
<span class="cstat-no" title="statement not covered" >  rootCas.addFile = module.exports.addFile;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return rootCas;</span>
};
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Sat Apr 22 2017 01:41:06 GMT+0000 (UTC)</div>
</div>
</body>
</html>
